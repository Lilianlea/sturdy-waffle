...
public:
    ...
    EMG_DATA_BITS getEMGDataBits()
    {
        return mEMGDataBits;
    }
    EMG_DATA_RATE getEMGDataRate()
    {
        return mEMGDataRate;
    }

    ACC_DATA_RATE getAccDataRate()
    {
        return mAccelDataRate;
    }
    GYRO_DATA_RATE getGyroDataRate()
    {
        return mGyroDataRate;
    }
    MAG_DATA_RATE getMagDataRate()
    {
        return mMagDataRate;
    }
    QUAT_DATA_RATE getQuatDataRate()
    {
        return mQuatDataRate;
    }
